...
<div class="card shadow">
	...
	<div class="card-body">
			...
			<div class="alert alert-warning">
				...
				<ul>
					@if ($appointment->cancellation)
						...
						<li>
							<strong>Motivo de Cancelación (Justificación): </strong> 
		...
		@if ($appointment->status == 'Reservada' && ($role == 'doctor' || $role == 'admin'))	       
			<form action="{{ url('/appointments/'.$appointment->id.'/confirm') }}" method="POST" class="d-inline-block">
				@csrf

				<button class="btn btn-success" data-toggle="tooltip" title="Confirmar cita" type="submit">
					Confirmar Cita
				</button>
			</form>
		@endif	
